...
$password = "u3ySDzy2j7hodg54sO3X8MrWV60=";     // A server generated Password you received from WhatsApp. This can NOT be manually created
...
$nickname = "Santies123";                          // This is the username (or nickname) displayed by WhatsApp clients.                       
...
$w->sendSetProfilePicture("demo/creativekits.jpg");

//send picture
$w->sendMessageImage($target, "demo/x3.jpg");
$w->sendStatusUpdate('Atención al cliente de CreativeKits.es');
