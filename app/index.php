...
<html lang=es>
	...
	<?=$analytics?>
		...
		<div class="featured">
			<div class="content slide"><h1>
				<span style="margin-top: 10px; margin-bottom: 5px; background: rgba(000,000,000,0.4);">Mes sin IVA</span></h1>
				<div style="text-align: justify; width: 250px; line-height: 120%;">
					Desde el 1 de octubre hasta el 31, en CreativeKits prohibimos el IVA en pedidos superiores a 30€.<br><br>Verás el precio final del pedido en el carro de la compra :)
				</div>
			</div>
		</div>
		<div class="fpbottom">
